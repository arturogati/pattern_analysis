...
class BearishHarami:
    ...
    def check_condition(self, df):
        ...
        # Проверяем третью свечу (красная и меньше четвёртой)
        third_red = df.iloc[2]["close"] < df.iloc[2]["open"]
        third_less_than_fourth = df.iloc[2]["close"] < df.iloc[3]["close"]
        ...
        return (
            ...
            third_red and third_less_than_fourth and
